...
frontend.setup({
  ...
  env = {
    ...
    PHENIX_FIXTURE_EXPECT_TOOL = "bash",
    PHENIX_FIXTURE_CALL_TOOL = "bash",
    PHENIX_FIXTURE_TOOL_COMMAND = "printf PHENIX_NVIM_BASH_TOOL",
    PHENIX_FIXTURE_EXPECT_TOOL_OUTPUT = "PHENIX_NVIM_BASH_TOOL",
